...
exports.wppNotifyPaymentDaily = functions.region("southamerica-east1").
    ...
    for (const user of listUserBoleto.keys()) {
        ...
        if ((_e = (_d = userData.data()) === null || _d === void 0 ? void 0 : _d.account_settings) === null || _e === void 0 ? void 0 : _e.daily_payment_notify) {
...
//# sourceMappingURL=wppNotifyPaymentDaily%20copy.js.map